...
test("desktop MCP keeps connection approval across tasks without permanent app trust", async () => {
  ...
  assert.equal(manifest.dependencies["@pgeske/mac-computer-use-mcp"], "https://github.com/pgeske/mac-computer-use-mcp/releases/download/v0.4.0/pgeske-mac-computer-use-mcp-0.4.0.tgz");
});
